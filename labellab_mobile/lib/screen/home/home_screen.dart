...
class HomeScreen extends StatelessWidget {
  ...
  void _goToChoice(BuildContext context, bool isCamera) {
    Application.router
        .navigateTo(context, '/classificationAndDetectionChoice/' + (isCamera ? 'camera' : "gallery"));
  }
}
