...
6. Get the **SHA1 fingerprint** by following the instruction(https://developers.google.com/android/guides/client-auth) and paste it in the SHA1 fingerprint field.
